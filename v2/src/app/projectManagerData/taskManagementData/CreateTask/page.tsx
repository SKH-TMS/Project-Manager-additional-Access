...
export default function ManageTeam() {
    ...
    const fetchTeams = async () => {
      try {
        const response = await fetch(
          "/api/projectManagerData/taskManagementData/getTeams",
          {
            method: "GET",
  ...
  const handleTeamChange = async (teamId: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/projectManagerData/taskManagementData/getProjects`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleTaskAssign = async () => {
    ...
    try {
      const response = await fetch(
        `/api/projectManagerData/taskManagementData/assignTask/${projectId}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
